...
本项目的安全模型，详见 [docs/security.md](docs/security.md)。关键默认值：
...
2. **生产推荐 `encrypted` 存储驱动**：`S3C_STORE_DRIVER=encrypted` + `S3C_STORE_KEY`（`sqlite` 驱动当前明文落盘密钥，见 [docs/security.md](docs/security.md)）
